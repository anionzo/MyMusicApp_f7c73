...
public class SearchSongAdapter extends  RecyclerView.Adapter<SearchSongAdapter.ViewHonder> {
    Context context;
    ArrayList<SongModel> songs;

    public SearchSongAdapter(Context context, ArrayList<SongModel> songs) {
